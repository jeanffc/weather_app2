...
import 'package:weather_app2/src/api/weather_api_client.dart';
import 'package:weather_app2/src/bloc/weather_bloc.dart';
import 'package:weather_app2/src/bloc/weather_event.dart';
import 'package:weather_app2/src/bloc/weather_state.dart';
import 'package:weather_app2/src/repository/weather_repository.dart';
import 'package:weather_app2/src/api/api_keys.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:weather_app2/src/widgets/weather_widget.dart';
          ...
          actions: <Widget>[
            Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
              ...
              IconButton(
                ...
                onPressed: () {
                  this._onOptionMenuItemSelected(OptionsMenu.changeCity);
                },
              ),
              IconButton(
                icon: Icon(
                ...
                onPressed: () {
                  this._onOptionMenuItemSelected(OptionsMenu.settings);
                },
              ),
            ]),
          ],
